...
let portalVersion = 1;
let dispatchState = [];
const publicFiles = new Set(['/index.html', '/community.html', '/style.css', '/live-map.css', '/account.css', '/script.js', '/dashboard.js', '/road-map.js', '/Logo.png', '/assets/js/portal-bridge.js']);
const publicPrefixes = ['/assets/'];
const authenticatedFiles = new Set(['/user.html', '/map.html', '/character.html', '/admin.html', '/map3d.js']);
